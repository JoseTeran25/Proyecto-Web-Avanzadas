    ...
    <section className="bg-white">
      <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form className="w-full max-w-md" onSubmit={handleIniciarSesion}>
          ...
          <Link href="#" className="inline-block mt-4 text-blue-500 hover:underline dark:text-blue-400">
            Olvidaste tu contraseña?
          </Link>

          <div className="mt-3">
            <button type="submit" className="w-full px-6 py-3 text-base font-bold tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
              Iniciar sesión
            </button>

            <p className="mt-4 text-center text-gray-600">o iniciar sesión con</p>
